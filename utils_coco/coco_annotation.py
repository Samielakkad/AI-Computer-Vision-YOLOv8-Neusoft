#-------------------------------------------------------#
#   Traite le jeu de données COCO : lit les fichiers JSON
#   d'annotations et génère des fichiers .txt pour l'entraînement.
#-------------------------------------------------------#
import json
import os
...
#-------------------------------------------------------#
#   Chemins vers les images d'entraînement et de validation COCO.
#-------------------------------------------------------#
train_datasets_path     = "coco_dataset/train2017"
val_datasets_path       = "coco_dataset/val2017"

#-------------------------------------------------------#
#   Chemins vers les fichiers d'annotations COCO (format JSON).
#-------------------------------------------------------#
...
#-------------------------------------------------------#
#   Chemins de sortie pour les fichiers .txt générés.
#-------------------------------------------------------#
